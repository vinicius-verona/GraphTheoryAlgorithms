...
class Graph {
    ...
    public:
        ...
        */
        ...
        /**
         * Execute BFS algorithm with initial_vertex as the starting point.
         * In case of a disconnected graph, the array containing the visiting
         * order only contains the order of the component in which initial_vertex exists.
         * 
         * @param initial_vertex is the starting point (vertex) for the BFS algorithm.
        */
